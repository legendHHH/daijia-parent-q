...
import com.legend.daijia.common.execption.DaiJiaException;
import com.legend.daijia.common.result.ResultCodeEnum;
import com.legend.daijia.model.entity.system.SysMenu;
import com.legend.daijia.model.entity.system.SysRoleMenu;
import com.legend.daijia.model.vo.system.AssginMenuVo;
import com.legend.daijia.model.vo.system.MetaVo;
import com.legend.daijia.model.vo.system.RouterVo;
import com.legend.daijia.system.helper.MenuHelper;
import com.legend.daijia.system.mapper.SysMenuMapper;
import com.legend.daijia.system.mapper.SysRoleMenuMapper;
import com.legend.daijia.system.service.SysMenuService;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public boolean removeById(Serializable id) {
        ...
        if (count > 0) {
            throw new DaiJiaException(ResultCodeEnum.NODE_ERROR);
        }
